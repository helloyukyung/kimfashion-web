  ...
  return (
    <div className="fixed z-[var(--z-header)] flex max-h-[100dvh] min-h-[50px] min-w-full flex-col items-center justify-center bg-black text-white laptop:min-h-[100dvh] laptop:min-w-[220px] laptop:px-[12px] laptop:py-[20px]">
      <button
        ...
        className="absolute left-[10px] top-[9px] hover:text-[var(--hashtag)] laptop:hidden"
      >
      ...
      <Link
        ...
        className="w-[60px] laptop:my-[40px] laptop:w-[140px]"
      >
      ...
      <div
        ...
        className={`${
          isMenuOpen
            ? "visible translate-x-0 opacity-100 duration-500"
      ...
      >
        <Link
          href="/news"
          className="block w-full py-[8px] hover:text-[var(--hashtag)]"
        >
          NEWS
        </Link>
        <Link
      ...
      <address className="hidden gap-[10px] text-[1.2rem] laptop:flex">
        <a
          href="mailto:official.kimfashion@gmail.com"
          className="hover:text-[var(--hashtag)]"
        >
          <CiMail size="24px" />
        </a>
        <a
          target="_blank"
          href="https://www.instagram.com/kimfashion_news"
          className="hover:text-[var(--hashtag)]"
        >
